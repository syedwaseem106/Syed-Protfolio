...
export function Planet(props) {
  ...
  useFrame((state) => {
    ...
    if (shapeContainer.current) {
      // Gentle parallax following the mouse
      shapeContainer.current.rotation.x = gsap.utils.interpolate(
        shapeContainer.current.rotation.x,
        mouse.y * 0.1,
        0.1
      );
      shapeContainer.current.rotation.y = gsap.utils.interpolate(
    ...
    if (ringContainer.current) {
        ringContainer.current.rotation.z += 0.002;
    }
  });
